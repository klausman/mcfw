...
if (mc_enable_dsl == 0) exitWith {
    ["fn_simpleSlingloading", "DSL has been disabled in mission parameters"
    ] call mc_fnc_rptlog;
};
...
DSL_fn_sling = {
    ...
    private _attachmentPoints = [_cargo] call DSL_Get_Corner_Points;
