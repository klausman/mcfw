 [10, [_this select 0], {
        private [
                    "_cargo","_nObject","_pilot","_Rope1","_Rope2","_Rope3","_Rope4","_widthFactor","_lengthFactor",
                    "_centerOfMass","_bbr","_p1","_p2","_maxWidth","_widthOffset","_maxLength","_lengthOffset",
                    "_maxHeight","_heightOffset","_rearCorner1","_rearCorner2","_frontCorner1","_frontCorner2"
                ];
