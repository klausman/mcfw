...
["Telepole", "Found %1 poles in global list: %2", count _poles, _poles] call mc_fnc_rptlog;

{
    private _obj = _x select 0;
    private _side = _x select 1;
    ["Telepole", "Re-initializing pole '%1' for side %2", _obj, _side] call mc_fnc_rptlog;
