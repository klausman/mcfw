// Safe Start
// This script inits the Mission Timer and the Safe Start, has the server
// setup the publicVariable while the client waits, sets units invincibility
// and displays hints, then disables it.
...
// If a value was set for the mission-timer, begin the safe-start loop and
